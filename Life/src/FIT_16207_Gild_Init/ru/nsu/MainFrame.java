...
public class MainFrame extends JFrame {
     ...
     * @param icon - file name containing icon (must be located in 'FIT_16207_Gild_Init.ru.nsu.resources' subpackage relative to your implementation of MainFrame), can be null
